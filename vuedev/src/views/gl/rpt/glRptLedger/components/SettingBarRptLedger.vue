          ...
          <!-- <a-popover trigger="click" v-model="exportPopVisible" placement="bottomRight">
            <template slot="content">
              <ul class="exportList" style="margin-bottom: 0;">
                ...
                <li style="line-height: 24px; cursor: pointer;" @click="exportTable">导出全部</li>
              </ul>
            </template>
            <a-tooltip placement="bottom">
              <template slot="title">
  ...
  methods: {
    ...
    print() {
      ...
      postprintModal({}, opt).then((result) => {
        ...
        console.log("that.printoption: ", that.printoption);
    ...
    /*
     * @Author: liwz
     * @Date: 2020-09-24 14:00
     * @LastEditTime: 2020-09-25 09:50
     * @LastEditors: Please set LastEditors
     * @Description: 导出全部  目前只有一个导出全部的按钮，总账页面去除导出本页功能
     *
     */
    exportTable() {
