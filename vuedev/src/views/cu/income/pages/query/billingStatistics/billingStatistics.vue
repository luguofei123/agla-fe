<template>
    <div>
        <table-list ref="tableList" :uuid="'billingStatistics'" tab-title="开票统计表"
...
<script>
    ...
    export default {
                ...
                this.$axios.post('/cu/incomePrint/getPrintDataForBase', params)
                    .then(res => {
                        if (res.data.flag === 'success') {
                            ...
                            getPdf('CU_TICKET_SUMMARY', '*', JSON.stringify(data));
                        } else {
                            this.$message.warning(res.data.msg);
                        }
                    })
        ...
        mounted() {
            ...
            this.tableConfig = {
                dataUrl: '/cu/incomeReport/selectTicketSummaryReport',
                dataParams: {
                    agencyCode: this.pfData.svAgencyCode
                }
            };
