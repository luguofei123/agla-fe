<!--
 * @Author: sunch
 * @Date: 2020-04-13 14:41:12
 * @LastEditTime: 2020-10-09 14:29:40
 * @LastEditors: Please set LastEditors
 * @Description: 部门工资汇总表
 * @FilePath: /ufgov-vue/src/views/prs/report/wageOrgReport/wageOrgReport.vue
 -->
<template>
  <div>
    <!-- 头部开始 -->
...
import { defaultColumns, defaultCheckedFields, defaultExportFormat } from './wageOrgReport' //固定显示的列
    ...
    exportEvent () {
      ...
      setTimeout(()=>{
        ...
        setTimeout(()=>{
          ...
          // 保存导出
          saveAs(blob, nameCode + this.pfData.svSetYear + '年' + this.mo + '月部门工资汇总表导出.xlsx',)
