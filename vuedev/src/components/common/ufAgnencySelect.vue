...
export default {
  ...
  data() {
    return {
      ...
      setting: {
        ...
        callback: {
          //如果不是叶子节点，则不允许点击，在部门应用设置页面取消 2020.09.28
          beforeClick: (treeId, treeNode) => {
            // console.log("callback treeNode: ", treeNode);
  ...
  created() {
    this.searchText = this.pfData.svAgencyCode + " " + this.pfData.svAgencyName;
  },
  mounted() {
    ...
    onClick(...arg) {
      ...
      if (arg[2].code) {
        ...
        this.$emit("change", {
          ...
          value: arg[2].code,
          agencyCodeName: arg[2].codeName,
          agencyCode: arg[2].code,
        });
      } else {
        this.searchText = "";
        this.selectId = "";
