    ...
    var page = function () {
        ...
        return {
            ...
            getAcctCode: function () {
                var data = window.ownerData.datas.accountBookVos;
                for (var i = 0; i < data.length; i++) {
                    var obj = {};
                    // obj.acctCode = data[i].CHR_CODE;
                    // obj.acctName = data[i].CODE_NAME;
            ...
            fixedTable: function (seq, seqDatas) {
                ...
                var colOnloadOne = [[        //支持多表头
                    ...
                    { type: 'input', field: 'descpt', name: '摘要', width: 220, headalign: 'center' },
                    {
                        type: 'money',
                        field: 'amtDr',
                        name: '借方金额',
            ...
            onEventListener: function () {
                ...
                $("#btnSave").on("click", function () {
                    ...
                    for (var i = 0; i < journal.length; i++) {
                        ...
                        if (window.ownerData.type == "0" && (journal[i]['jouDate'] == null || journal[i]['jouDate'] == '')) {
                    ...
                    var argu = {
                        ...
                        agencyAmt: page.transformMoney(window.ownerData.bankChangeInput),
                        bankAmt: page.transformMoney(window.ownerData.reconChangeInput),
                        statementLs: []
                    };
                    if (window.ownerData.type == "0") {
