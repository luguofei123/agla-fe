...
(function($){ 	
	...
	var init = function( tb, options){	
		...
		createGrips(t,options.last);		//grips are created 
	 ...
	 * @param {jQuery ref} t - table object
	 */
	var createGrips = function(t,last){	
        ...
        if(last == 1){
            th = t.find(">thead>tr:last>th,>thead>tr:last>td"); //table headers are obtained
            if(!th.length) th = t.find(">tbody>tr:last>th,>tr:last>th,>tbody>tr:last>td, >tr:last>td");	
        }
    ...
    $.fn.extend({  
        colResizable: function(options) {           
            var defaults = {
                ...
                onResize: null,
                last:0				//callback function fired when the dragging process is over
            }			
