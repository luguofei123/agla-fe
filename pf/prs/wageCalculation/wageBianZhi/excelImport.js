...
$(function () {
    ...
    //接口URL集合
    var interfaceURL = {
        searchPrsExcelStyle:"/prs/base/prsExcelStyleCo/searchPrsExcelStyleCo",//查询
        uploadExcel:"/prs/prscalcdata/uploadExcel"//导入
    };
    var page = function () {
        return {
            //表格列
            ...
            onEventListener: function () {
                ...
                $("#data-import-btn").on("click",function () {
                    ...
                    $("input[name=typeCode]").val(ownerData.typeCode);
                    $("input[name=id]").val(rowData.id);
                    $("input[name=sheetid]").val(rowData.sheetid);
                    $("input[name=isNeedCalc]").val(rowData.isNeedCalc);
