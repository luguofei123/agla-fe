$(function () {
    ...
    var interfaceURL = {
        ...
        printSalarySlipPrintData:"/prs/rpt/PrsRptData/printSalarySlipPrintData"//获取打印数据
    };
    var pageLength = 25;
    var newCellsData = [];
    var isGet = false;
                    ...
                    "initComplete": function (settings, json) {
                      ...
                      //导出begin
                        $("#dtToolbar .buttons-print").off().on('click', function (evt) {
                            ...
                            ufma.post(interfaceURL.printSalarySlipPrintData, argu, function (result) {
                            	var data = JSON.stringify(result.data);
                            	getPdf("salarySlipPrint","*",data);
                            })
                        ...
                        $("#dtToolbar .buttons-excel").off().on('click', function (evt) {
                            ...
                            evt.preventDefault();
                            ufma.expXLSForDatatable($('#' + id), '工资条');
                        });
                        // 导出end
