	...
	var page = function() {
		...
		return {
			...
			setForm: function() {
				...
				$('#receivableType').val('背书');
			},
			onEventListener: function() {
				//CWYXM-8319--经海哥确认背书人、被背书人只可以有汉字英文数字小括号--zsj
				$('.controlReg').on('keyup parse', function() {
			...
			//		$(this).val($(this).val().replace(/[(\~)(\!)(\#)(\$)(\%)(\^)(\&)(\*)(\=)(\[)(\])(\{)(\})(\|)(\\)(\;)(\')(\")(\<)(\>)(\)(\.')(\',)(\_)(\/),(\:)(\?)(\ )(\@)(\+)(\-)(\……)(\——)(\】)(\【)(\、)(\；)(\‘)](\’)(\“)(\”)(\《)(\》)(\？)(\·)(\=)(\+)(\-)(\￥)/g, ''))
				...
				$('#btnSave').click(function() {
					...
					argu.op = 0; //新增传0，修改传1
					argu.receivableType = "02"; //登记是01，背书是02
					...
					if($.isNull(argu.billEndorsor) || $.isNull(argu.billEndorsee) || $.isNull(businessDate)) {
