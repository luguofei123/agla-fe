$(function () {
	...
	var page = function () {
		...
		var portList = {
			...
			getBankImpScheAss: "/gl/bank/statement/getBankImpScheAss", //请求具体数据格式内容
			saveBankImpSche: "/gl/bank/statement/saveBankImpSche", //保存格式方案
			delBankImpSche: "/gl/bank/statement/delBankImpSche" //删除格式方案
		};
		return {
			...
			saveImpSche: function (flag) {
				...
				if (page.impType == "1") { //文本文件
					...
					arguObj["billDate"] = $.inArrayJson(tableData, "code", "billDate").text;
