...
ufma.ajaxDef('/df/access/public/bg/api/getUseBudgetSet','get','',function(data){
	if(data.data != 1){
...
for(var z = 0; z < isbtnpermission.length; z++) {
	if(isbtnpermission[z].role_id!=undefined){
...
function locationsdetail(ths){
	...
	$('.voucher-center').removeClass('voucher-center-active')
