    ...
    var columns = [
        ...
        },
        {
            ...
            render: function (data, type, rowdata, meta) {
                ...
                // liuyyn 凭证生成-凭证号 生成后显示时凭证号字段被截取导致数据显示不完整，如需截取该字段，用以下注释部分
                // if (data.length > 0) {
    ...
    var page = function () {
        ...
        return {
                ...
                page.tableObj = $("#" + id).DataTable({
                    ...
                    "initComplete": function () {
                        ...
                        $("#showTable").on("click",".check-vou",function (e) {
                            ...
                            $(".u-msg-dialog-top", parent.document).prevAll("#tarBillGenerate").find("#open-check-vou").click();
                            // ufma.get(interfaceURL.viewVoucher + oneData.BILL_GUID, "", function (result) {
                            //     //凭证弹窗
                            //     // var urlPath = "http://127.0.0.1:8083";
                            //     var urlPath = "";
                            //     ufma.open({
                            //         url: urlPath + '/pf/gl/vou/index.html?menuid=6661003001001&action=preview&dataFrom=vouBox&preview=0',
                            //         title: '查看凭证',
                            //         width: 1200,
                            //         // height:500,
                            //         data: result.data,
            ...
            onEventListener: function () {
                ...
                //点击表格中的查看凭证
                // $("#showTable").on("click", ".check-vou", function () {
                //     var tr = $(this).parents("tr");
                //     var trData = page.tableObj.rows(tr).data()[0];
                // });
                //点击取消
            ...
            init: function () {
                ...
                //     var topVal = $("#tool-bar").css("top");
                //     $("#tool-bar").css("top",parseInt(topVal)-49 + "px");
                // })
