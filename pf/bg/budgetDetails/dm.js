var dm = $.extend(true, ufma.getCommonData(), {
  ...
  //       $('#targetStatus').getObj().val(tmpDataArr.targetStatus)
  //       $('#targetState').ufmaTextboxlist().val(tmpDataArr.targetState)
	...
	// 					if(assiData[z].eleCode == code && assiData[z].eleCode != 'ISUPBUDGET') {
