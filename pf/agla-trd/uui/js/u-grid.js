...
!function(modules) {
    ...
    !function(global, factory) {
        ...
        var createDivs = function() {
            ...
            return this.options.showSumRow && (sumRowClass = "u-grid-content-left-sum"), this.options.multiSelect && (htmlStr += '<div class="u-grid-content-left u-grid-content-left1 ' + sumRowClass + '" id="' + this.options.id + '_content_multiSelect" style="width:' + this.multiSelectWidth + "px;" + hStr + '">', 
            this.dataSourceObj.rows && $.each(this.dataSourceObj.rows, function(i) {
                htmlStr += oThis.createContentLeftMultiSelectRow(this);
            }), htmlStr += "</div>", left += this.multiSelectWidth), this.options.showNumCol && (htmlStr += '<div class="u-grid-content-left u-grid-content-left2 ' + sumRowClass + '" id="' + this.options.id + '_content_numCol" style="width:' + this.numWidth + "px;left:" + left + "px;" + hStr + '">', 
