...
//      '</div>',
        DEFAULT_PREVIEW: '<img class="attach-img-file" src="img/other.png"/>',
    ...
    FileInput.prototype = {
        ...
        _init: function (options) {
            ...
            self.$caption = $h.getElement(options, 'elCaptionText', $(".attach-uploaded-info"));
        ...
        _initTemplateDefaults: function () {
            ...
            tMain1 = '{preview}\n' +
                ...
                '<div class="input-group {class}" style="margin-left:5px;">\n' +
                '   {caption}\n' +
            ...
            tCaption = '<div tabindex="500" style="display:none;" class="form-control file-caption {class}">\n' +
            ...
            tFooter = '<div class="file-thumbnail-footer">\n' +
                '    <div class="file-footer-caption" title="{caption}"><div class="file-footer-caption1">{caption}</div><div class="file-footer-caption2">{size}</div><div class="clear:both;"></div></div>\n' +
                '    {progress} {actions}\n' +
                '</div>';
            ...
            tActionUpload = '<span class="kv-file-upload {uploadClass}" title="{uploadTitle}">' +
                '{uploadIcon}</span>';
            ...
            tTagAft = '</div>{footer}\n</div>\n';
            tGeneric = '{content}\n';
            tHtml = '<img class="attach-img-file" src="img/other.png"/>\n';
...
//              $h.STYLE_SETTING + '>{data}</textarea>\n';
            tText = '<img class="attach-img-file" src="img/txt.png"/>\n';    
            tVideo = '<img class="attach-img-file" src="img/other.png"/>\n\n';
            tAudio = '<img class="attach-img-file" src="img/other.png"/>\n';
            tFlash = '<img class="attach-img-file" src="img/other.png"/>\n';
//          tObject = '<object class="kv-preview-data file-object {typeCss}" data="{data}" type="{type}" ' +
//              'width="{width}" height="{height}">\n' + '<param name="movie" value="{caption}" />\n' +
//              $h.OBJECT_PARAMS + ' ' + $h.DEFAULT_PREVIEW + '\n</object>\n';
 			tObject = '<img class="attach-img-file" src="img/other.png"/>\n';
            tPdf = '<img class="attach-img-file" src="img/other.png"/>\n\n';
            
//          tOther = '<div class="kv-preview-data file-preview-other-frame">\n' + $h.DEFAULT_PREVIEW + '\n</div>\n';
            tOther = '<img class="attach-img-file" src="img/other.png"/>\n';
            ...
            self.defaults = {
                ...
                fileActionSettings: {
                    ...
                    zoomIcon: '<i class="glyphicon icon-search"></i>',
                    zoomClass: '',
    ...
    $.fn.fileinput.defaults = {
        ...
        previewZoomButtonIcons: {
            prev: '<i class="glyphicon icon-angle-left"></i>',
    ...
    $.fn.fileinputLocales.en = {
        ...
        msgUploadThreshold: '进行中...',
        msgUploadBegin: '初始化...',
        msgUploadEnd: '完成',
        msgUploadEmpty: '目前没有可上传的文件',
        ...
        msgAjaxError: '{operation}出错了。请稍候再试！',
