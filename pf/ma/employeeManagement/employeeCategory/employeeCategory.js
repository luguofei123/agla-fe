$(function () {
    ...
    //接口URL集合
    var interfaceURL = {
        selectEmpClass: "/ma/emp/EmpClass/selectEmpClass",//查询
        delEmpClass: "/ma/emp/EmpClass/delEmpClass",//删除人员类别
        able: "/ma/emp/EmpClass/able",//停用/启用
    };
    var pageLength = 25;
    ...
    var page = function () {
        return {
                ...
                var columns = [
                    {
                        ...
                        "render": function (data, type, rowdata, meta) {
                            return '<label class="mt-checkbox mt-checkbox-single mt-checkbox-outline"> ' +
                                '<input type="checkbox" class="checkboxes" data-id="' + rowdata.classCode + '" isSys="' + rowdata.isSys + '" />' +
                                '&nbsp;<span></span></label>';
                        }
                    },
                    {
                    ...
                    },
                    {
                        ...
                        "render": function (data, type, rowdata, meta) {
                            ...
                            return '<a class="btn btn-icon-only btn-edit btn-permission" data-id="' + rowdata.classCode + '" data-rowdata=\''+newRowData+'\' action= "" title="修改">' +
                                ...
                                '<a class="btn btn-icon-only btn-delete btn-permission" data-id="' + rowdata.classCode + '" isSys="' + rowdata.isSys + '" action= "" title="删除">' +
                ...
                page.DataTable = $('#' + id).DataTable({
                    ...
                    "initComplete": function (settings, json) {
                        ...
                        $("#dtToolbar .buttons-excel").off().on('click', function (evt) {
                            ...
                            evt.preventDefault();
                            ufma.expXLSForDatatable($('#' + id), $(".uf-title").text());
                        });
                        //导出end
            ...
            delValues: function (ele) {
                ...
                if (!page.isCanDel(ele)) {
                	ufma.showTip("系统预置数据不可删除", function () {
                    }, "warning");
                    return false;
                }
//                debugger;
