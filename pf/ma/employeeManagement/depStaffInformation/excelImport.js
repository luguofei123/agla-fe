...
$(function () {
    ...
    //接口URL集合
    var interfaceURL = {
        selectPrsExcelStyleEmp:"/ma/base/prsExcelStyleEmpCo/selectPrsExcelStyleEmpCo",//查询
        uploadExcel:"/ma/emp/maEmp/impEmpInformationExcel", //导入
        exportEmpTemplateFile: "/ma/base/prsExcelStyleEmpCo/exportEmpTemplateFile"
    };
    var page = function () {
        return {
            //表格列
            ...
            initTable:function (data) {
                ...
                page.DataTable = $('#' + id).DataTable({
                    ...
                    "initComplete": function (settings, json) {
                        ...
                        $("#tool-bar").css({"top":conH + 5 + "px","position":"absolute","bottom": "auto"});
            ...
            onEventListener: function () {
                ...
                $("#btn-exportTemp").on("click", function() {
                    //校验
                    ...
                    rowData.agencyName = ownerData.agencyName
                    ufma.post(interfaceURL.exportEmpTemplateFile, rowData, function (result) {
                ...
                $("#data-import-btn").on("click",function () {   
                    ...
                    formData.append('agencyCode', ownerData.agencyCode)
                    $.ajax({
