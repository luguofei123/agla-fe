$(function() {
  ...
  //接口URL集合
  var interfaceURL = {
    save: '/ma/emp/prsOrg/save', // 部门新增/修改
    getPrsOrgCodeRule: '/ma/emp/prsOrg/getPrsOrgCodeRule', // 部门编码规则
    getPrsOrgEmp: '/ma/emp/prsOrg/getPrsOrgEmp' // 获取负责人信息
  }
  var pageLength = 25
  ...
  var page = (function() {
    return {
      ...
      initSubPrincipal: function(data){
        $('#subPrincipal').ufTreecombox({
          idField: 'empCode',
          textField: 'empName',
          pIdField: 'pCode', //可选
      ...
      initFormData: function() {
        if (window.ownerData.isUpdate) {
          ...
          console.log(window.ownerData.depData)
          ufma.post(interfaceURL.getPrsOrgEmp, argu, function(result) {
            ...
            $('#frmQuery').setForm({
              ...
              ordIndex: window.ownerData.depData.ordIndex,
              isUsed: window.ownerData.depData.isUsed,
              principal: window.ownerData.depData.principal,
              subPrincipal: window.ownerData.depData.chargePrincipal,
          ...
          ufma.post(interfaceURL.getPrsOrgEmp, argu2, function(result) {
            page.initSubPrincipal(result.data)
          })
          ...
          ufma.post(interfaceURL.getPrsOrgEmp, argu3, function(result) {
            page.initSubPrincipal(result.data)
          })
      ...
      saveAdd: function(formData) {
        ...
        var argu = {
          ...
          ordIndex: formData.ordIndex?formData.ordIndex:0,
          ...
          principal: $('#principal')
            .getObj()
            .getValue(),
          chargePrincipal: $('#subPrincipal').getObj().getValue(),
          tel: formData.tel,
          op: 0
        }
