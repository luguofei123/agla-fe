$(function() {
  ...
  //接口URL集合
  var interfaceURL = {
    pageMaEmpProperty: '/ma/emp/maEmpProperty/pageMaEmpProperty', // 展示人员属性
    delMaEmpProperty: '/ma/emp/maEmpProperty/delMaEmpProperty', // 批量删除人员属性
    setIsUsedMaEmpProperty: '/ma/emp/maEmpProperty/setIsUsedMaEmpProperty' // 启用/禁用
  }
  var pageLength = 25
        ...
        var columns = [
          {
            ...
            className: 'checkbox-center nowrap check-style no-print ',
      ...
      initTable: function(data) {
        ...
        page.DataTable = $('#' + id).DataTable({
          ...
          initComplete: function(settings, json) {
            ...
            $('#employee-property-table').fixedTableHead();
          ...
          drawCallback: function(settings) {
            ...
            ufma.isShow(page.reslist)
            ufma.setBarPos($(window))
            $('#' + id + '_wrapper').ufScrollBar('destroy')
            $('#' + id + '_wrapper').ufScrollBar({
              hScrollbar: true,
              mousewheel: false
            })
