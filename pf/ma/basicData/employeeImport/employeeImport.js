$(function () {
    ...
    //接口URL集合
    var interfaceURL = {
        selectPrsExcelStyleEmp:"/ma/sys/prsExcelStyleEmp/selectPrsExcelStyleEmp",//查询页面数据
        delPrsExcelStyleEmp:"/ma/sys/prsExcelStyleEmp/delPrsExcelStyleEmp",//删除
        getAgencyTree:"/ma/sys/eleAgency/getAgencyTree",//下发树"
        sendPrsEmpExcelStyle:"/ma/sys/prsExcelStyleEmp/sendPrsEmpExcelStyle",//下发
        removeAllPrsExcelStyleEmpCoList:"/ma/sys/prsExcelStyleEmp/removeAllPrsExcelStyleEmpCoList"//清空
    };
    if($("body").attr("data-code")){
        interfaceURL.delPrsExcelStyleEmp = "/ma/base/prsExcelStyleEmpCo/delPrsExcelStyleEmpCo";
        interfaceURL.selectPrsExcelStyleEmp="/ma/base/prsExcelStyleEmpCo/selectPrsExcelStyleEmpCo"
    }
