...
(function (factory) {
    ...
    $h = {
        ...
        /*
         *  修改财务监管安全报告问题：Flash 参数 AllowScriptAccess 已设置为 always---修改建议将 AllowScriptAccess 参数设置为“sameDomain”，它会告诉 Flash 播放器仅从同一个域加载作为父级
            SWF 的 SWF 文件才会对主管 Web 页面具有脚本访问权限
            --zsj
         */
...
//              $h.STYLE_SETTING + '>{data}</textarea>\n';
            ...
            tFlash = '<object class="kv-preview-data file-object" type="application/x-shockwave-flash" ' +
                'width="{width}" height="{height}" data="{data}">\n AllowScriptAccess="sameDomain"' + $h.OBJECT_PARAMS + ' ' + $h.DEFAULT_PREVIEW +
                '\n</object>\n';
            ...
            tPdf = '<embed class="kv-preview-data" src="{data}" ' +
                ...
                '<div class="attach-img-file-pos-bg"><img class="attach-img-file-pos" src="img/pdf.png"/></div>\n';
